...
You don't need to write code to explore VFB's data. We provide two natural-language routes:

### Route B: MCP Tool in Your LLM

The [VFB MCP tool](https://vfb3-mcp.virtualflybrain.org) runs inside your LLM (Claude, etc.) and lets you chain VFB queries with your own reasoning and other tools.
...
[chat.virtualflybrain.org](https://chat.virtualflybrain.org) is a guardrailed natural-language interface to VFB — nothing to install or configure.
